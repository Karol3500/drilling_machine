...
public class IwoSmallIncreaseMinSeedNumberMove implements Move {
	private static final long serialVersionUID = 1L;

	@Override
	public void operateOn(Solution soln) {
		IwoParameters params = (IwoParameters)((DmpParametersSolution)soln).getParameters();
		params.setMinSeedNumber(DmpParamsMoveUtil.getSlightlyIncreasedInt(
				params.getMinSeedNumber(),
				(int)IwoParameter.MIN_SEED_NUMBER.changeStep,
